...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button cancelAlarm,
      @NonNull LinearLayout main, @NonNull TextView selectTime, @NonNull Button setAlarm) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, cancelAlarm, main, selectTime,
          setAlarm);
    }
